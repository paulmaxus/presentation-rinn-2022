...
- **purposeful design**: at the same time, select and taylor dataset and visuals to target a user's research questions
...
- Data model provides many ways to explore the dataset (flexibility)
- We can create custom dashboards linked to the same underlying dataset (purposeful design)
- ![](images/pbi_lineage.png)
